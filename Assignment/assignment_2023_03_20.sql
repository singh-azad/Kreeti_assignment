...
SELECT * FROM employees WHERE last_name ILIKE 'Sah%';

--2.
--Select 10 employees who were hired between 1st June, 2021 to 15th February,
...
--3.
--Find distinct top 5 salary values (only salary column), using alias for column as
--“Top 5 salaries”

SELECT salary AS "Top 5 slaries" FROM employees ORDER BY salary DESC LIMIT 5;

--4.
-- Find first_name, last_name and email of employees from the employees table
...
-- 5.
-- Write a query to find first_name, manager_id and salary where the
